...
class CategoryService {
  async createCategory(categoryData) {
    try {
      ...
      logger.error(`Service error - Failed to create category: ${error.message}`);
      throw error;
    }
  }
  ...
  async getAllCategories() {
    try {
      ...
      logger.error(`Service error - Failed to fetch categories: ${error.message}`);
      throw error;
    }
  }
  ...
  async updateCategory(id, updateData) {
    try {
      ...
      logger.error(`Service error - Failed to update category: ${error.message}`);
      throw error;
    }
  }
  ...
  async deleteCategory(id) {
    try {
      ...
      logger.error(`Service error - Failed to delete category: ${error.message}`);
      throw error;
    }
  }
}
